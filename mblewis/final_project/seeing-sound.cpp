...
class DistributedExampleApp : public DistributedAppWithState<SharedState> {
public:
    ...
    DistributedExampleApp(){
        ...
        configureAudio(44100, 1024, 60, 60);
    }
...
// -----------------------------------------------------------------------
    ...
    virtual void onDraw(Graphics& g) override {
        ...
        if (hasCapability(CAP_RENDERING) || hasCapability(CAP_CONSOLE_IO) ||
            hasCapability(CAP_RENDERING)) {
